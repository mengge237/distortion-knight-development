...
namespace MutationChess.Battle
{
    public class BattleManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (gameManager == null)
            {
                Debug.LogWarning("BattleManager: 未找到 GameManager引用 部分功能可能无法正常工作");
            }
        ...
        void OnPlayerTurnStart()
        {
            ...
            {
                actionHintText.text = "选择一个敌人 作为攻击目标";
        ...
        void ShowStoredEnemyIntent()
        {
            ...
            {
                Debug.LogWarning("EnemyIntentUI 未找到");
            }
        }
        ...
        IEnumerator ExecuteStoredEnemyIntentRoutine()
        {
            ...
            switch (currentIntent)
            {
                ...
                case EnemyIntentType.Wait:
                    AddLog($"{currentEnemy.enemyName} 开始执行行动...");
        ...
        IEnumerator ExecuteAttack()
        {
            ...
            if (playerBlock > 0)
                AddLog($"格挡抵消 {Mathf.Min(dmg, playerBlock)}伤害");
            ...
            if (actual > 0)
            {
                ...
                AddLog($"{currentEnemy.enemyName} 造成了 {actual} 点伤害");
        ...
        IEnumerator ExecuteDefend()
        {
            ...
            AddLog($"{currentEnemy.enemyName} 恢复了 {healAmount} 点生命值");
        ...
        IEnumerator ExecuteSpecial()
        {
            ...
            if (actualSpecial > 0)
            {
                ...
                AddLog($"{currentEnemy.enemyName} 造成了 {actualSpecial} 点特殊伤害");
                currentEnemy.PlayAttack();
            }
            else
            {
        ...
        IEnumerator ExecuteBuff()
        {
            ...
            AddLog($"{currentEnemy.enemyName} 获得了易伤 {buffAmount}");
            currentEnemy.PlayHurt();
            yield return new WaitForSeconds(0.5f);
        }
        ...
        public void ToggleView()
        {
            ...
            if (isViewingMap)
            {
                ...
                {
                    var turnManager = TurnManager.Instance;
                    actionHintText.text = (turnManager != null && turnManager.IsPlayerTurn) ? "选择一个敌人 作为攻击目标" : "等待指令...";
        ...
        private void SetBattleBackground(EnemyType enemyType, string enemyName)
        {
            ...
            else
            {
                ...
                Debug.LogWarning($"未找到敌人 {enemyName} 的背景配置");
            }
        }
        ...
        public void PlayerAttack(int damage)
        {
            if (currentEnemy == null)
            {
                Debug.LogWarning($"PlayerAttack: currentEnemy 已被击败 {damage} 未生效");
                waitingForPlayerInput = true;
                return;
            }
        ...
        public void PlayerBlock(int blockAmount)
        {
            ...
            AddLog($"获得了 {finalBlock} 点格挡 (当前: {playerBlock})");
        ...
        void EndBattle(bool victory)
        {
            ...
            AddLog(victory ? "=== 胜利 ===" : "=== 战败 ===");

            if (actionHintText != null)
            {
                actionHintText.text = victory ? "胜利!" : "战败...";
            ...
            if (victory)
            {
                ...
                if (relicManager != null && dataManager != null)
                {
                    ...
                    if (goldPercent > 0)
                    {
                        ...
                        if (bonusGold > 0)
                        {
                            ...
                            AddLog($"储蓄罐发动！额外获得 {bonusGold} 金币 ({goldPercent * 100}%)");
                        }
                    }
                }
                ...
                if (gameManager == null)
                {
                    Debug.LogError("BattleManager: 奖励系统 GameManager引用无法正常工作");
                ...
                {
                    Debug.LogWarning("RewardPool 为空 使用默认奖励");
